...
st.set_page_config(page_title="IDX Professional Trading System v2.9 Ultimate", layout="wide")
st.title("📊 IDX Professional Trading System v2.9 Ultimate")
st.caption("Top-Ranked Realistic + Trending + Grade A/B/C + Manual Default + Buy/Sell/Wait")
...
# ===============================
    ...
    st.dataframe(ranked[["Symbol","Close","RSI","TrendScore","Momentum","Score","Grade","Decision"]], use_container_width=True)
